...
connection.onHover((docPosition) => {
...
connection.listen();
function evalMoveTo(raw, line, start, end) {
    const diagnostics = [];
...
function evalAtSpeed(raw, line, start, end) {
    const diagnostics = [];
...
function evalWithHdop(raw, line, start, end) {
    const diagnostics = [];
...
function evalWithSatellites(raw, line, start, end) {
    const diagnostics = [];
...
function evalWithAltitude(raw, line, start, end) {
    const diagnostics = [];
...
function evalWithParam(raw, line, start, end) {
    const diagnostics = [];
...
function evalWait(raw, line, start, end) {
    const diagnostics = [];
...
function evalAtDirection(raw, line, start, end) {
    const diagnostics = [];
